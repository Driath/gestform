...
describe('AppComponent', () => {
  ...
  it('List number should contain random number between -1000 and 1000', () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    const listNumber: number[] = app.generateRandomNumber();
  ...
  it('For a number N from the list number, if N is divisible per 3 and per 5 return GestForme', () => {
    ...
    const listNumberManaged = listNumber.map(n => app.manageNumber(n));
    listNumberManaged.forEach(nManaged => {
      expect(nManaged).toBe('GestForme');
    });
  });
  ...
  it('manageNumber should return an error if send not a number', () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    const expectAnErrorThere = app.manageNumber('Coucou :)');
    expect(expectAnErrorThere).toThrowError('Expected a number');
  });

  it('Given [1,3,5,15,22] list number, Should return [1, "Geste", "Forme", "GesteForme", 22]', () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    const givenListNumber = [1, 3, 5, 15, 22];
    const expectedListNumber = givenListNumber.map(n => app.managedNumber(n));
    expect(expectedListNumber).toBe([1, 'Geste', 'Forme', 'GesteForme', 22]);
  });
});
